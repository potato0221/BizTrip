package com.ll.biztrip.domain.transport.flight.service;
...
import com.ll.biztrip.domain.transport.flight.repository.AirlineRepository;
import com.ll.biztrip.domain.transport.flight.repository.AirportRepository;
import com.ll.biztrip.domain.transport.flight.repository.FlightRepository;
...
public class FlightService {
    ...
    public void updateAirport() {
        ...
        try {
            for (int i = 1; i <= 1; i++) {
                // 1. URL 설정
                StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1613000/DmstcFlightNvgInfoService/getArprtList");
