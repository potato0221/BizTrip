package com.ll.biztrip.global.enums;
...
public enum Msg {
    ...
    E400_4_ALREADY_REGISTERED_LEG("400-4", "이미 플랜에 등록된 교통 수단 입니다"),
    E400_5_ALREADY_REGISTERED_MEMBER("400-5", "이미 존재하는 회원입니다."),

    E400_6_INCORRECT_PASSWORD("400-6", "비밀번호가 일치하지 않습니다."),
    E400_7_NOT_FOUND_USER("400-7", "해당 유저가 존재하지 않습니다."),
    E400_8_NOT_FOUND_REFRESH_TOKEN("400-8", "존재하지 않는 리프레시 토큰입니다."),
