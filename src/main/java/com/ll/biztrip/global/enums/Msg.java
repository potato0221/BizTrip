...
public enum Msg {
    ...
    E400_5_NOT_FOUND_USER("400-6", "해당 유저가 존재하지 않습니다."),
    E400_6_INCORRECT_PASSWORD("400-2", "비밀번호가 일치하지 않습니다."),
    E400_7_NOT_FOUND_REFRESH_TOKEN("400-7", "존재하지 않는 리프레시 토큰입니다."),
    E500_0_CSV_READ_FAIL("500-0", "CSV 읽기에 실패했습니다."),
    E500_1_INTERNAL_SERVER_ERROR("500-0", "서버 내부 오류가 발생했습니다.");
